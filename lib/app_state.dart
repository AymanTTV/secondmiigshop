...
class FFAppState extends ChangeNotifier {
  ...
  List<ShippingOptionsStruct> _shippingOptions = [
    ShippingOptionsStruct.fromSerializableMap(jsonDecode(
        '{\"shippingName\":\"Rikaab\",\"description\":\"Get your shipment in 2-3 business days\",\"price\":\"25\"}')),
    ShippingOptionsStruct.fromSerializableMap(jsonDecode(
        '{\"shippingName\":\"Bajaaj Delivery\",\"description\":\"Get your shipment in 5-7 business days\",\"price\":\"10\"}')),
    ShippingOptionsStruct.fromSerializableMap(jsonDecode(
